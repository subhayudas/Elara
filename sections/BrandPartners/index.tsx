...
// Jewelry collections data
const brands = [
  { name: "Engagement Rings", logo: "/ImageContainer/logoskechers.jpg" },
  { name: "Wedding Collections", logo: "/ImageContainer/logoguess.webp" },
  { name: "Diamond Jewelry", logo: "/ImageContainer/logocalvinklein.png" },
  { name: "Custom Designs", logo: "/ImageContainer/logobugatti.webp" },
  { name: "Precious Gemstones", logo: "/ImageContainer/logonewbalance.png" },
  { name: "Earrings", logo: "/ImageContainer/logoreebok.jpg" },
  { name: "Necklaces", logo: "/ImageContainer/logoluxottica.png" },
  { name: "Bracelets", logo: "/ImageContainer/logoseven.jpg" },
  { name: "Pendants", logo: "/ImageContainer/logoshrey.jpg" },
];
