...
export default function ClipImageCard({
  ...
  return (
    <motion.div
      ...
      style={{ ...style }}
      className={cn(
        "relative z-10 flex h-full flex-col items-center justify-between py-[8vh] text-[#d1bebe] backdrop-brightness-[60%] md:flex-row md:px-16 md:py-[15vh]",
        className,
      )}
    >
      ...
      <motion.div
        ...
        className="relative z-20 my-[5vh] flex h-[70vh] min-h-fit w-[90%] flex-col items-center gap-8 bg-[#d1bebe] p-5-75 text-[#4a1a1a] md:h-full md:max-h-172 md:w-full md:max-w-118 md:px-8 md:py-4"
      >
